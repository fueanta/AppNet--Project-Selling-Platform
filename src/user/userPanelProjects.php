...
<body>
	...
	<hr>
	<div class="projects">
		<a href="uploadProject.php"><input type="button" name="uploadProject" value="Upload Project"><br/></a>
		<span class="heading">
					All projects
		</span>
		<div class="projectData">
			...
			<?php
				...
				$table = fetch_uploaded_project_for_user($_SESSION['user_id']);
				while ($row = mysqli_fetch_array($table)) {
					...
					echo "
						<p>
							<a href='projectPageUser.php?project=" . $project_id . "'><img src='../../images/icons/" . $icon . "'></a><br/>
							" . $title . "
						</p>
					";
				}
