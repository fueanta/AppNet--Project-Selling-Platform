<?php
	...
	if (isset($_COOKIE["nimda"]) && $_SESSION["admin"] = true) {
		// code...
		$project_id = $_GET['project'];
		header('Location:../admin/projectPageAdmin.php?project=' . $project_id);
	}
	elseif (isset($_SESSION['user_id'])) {
		// code...
		$project_id = $_GET['project'];
		$row = get_owned_project_by_id($project_id, $_SESSION['user_id']);
		if ($row) {
			header('Location:puchasedProject.php?project=' . $project_id);
		}
		$row = get_uploaded_project_by_id($project_id, $_SESSION['user_id']);
		if ($row) {
...
<body>
	...
	<div class="projectInfo">
		<?php
			...
			$project_id = $_GET['project'];
			$_SESSION['buyProject'] = $project_id;
			...
			$_SESSION['payableAmount'] = $payable;
			...
			echo "
				...
				<a href=\"buyProject.php?project=$project_id\"><button class=\"firstbtn\">Buy</button></a>
			</div>
